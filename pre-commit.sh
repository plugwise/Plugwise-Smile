...
grep -r --include="*.xml" '<hostname>' tests/* | grep -v 'smile000000' && echo "COMMIT REJECTED, found a Smile hostname, modify domain_objects and set hostname to smile000000!" && exit 1
